...
const register = async (email: string, password: string, displayName: string, username: string): Promise<UserCredential> => {
...
const login = async (identifier: string, password: string): Promise<UserCredential> => {
  try {
